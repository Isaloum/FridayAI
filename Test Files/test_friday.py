# =====================================
# test_fridayAI.py - Modular Test Scaffold (Isolated)
# =====================================
...
try:
    ...
    EMOTION_LOG_FILE = "test_emotion_log.json"
    emotion = EmotionCore(emotion_log_file=EMOTION_LOG_FILE)
except ImportError:
    emotion = None
...
os.remove(KEY_FILE)
print("\n🧹 Test memory cleared.")
print(f"📄 Emotion log remains for review: {EMOTION_LOG_FILE}")
