...
async def chat_endpoint(request: ChatRequest):
    # Your existing FridayAI logic here
    return {
        "response": "Your FridayAI response here",
...
if __name__ == "__main__":
    ...
    try:
        ...
        if 'ai' in locals() and ai:
            ...
            # ADD THE PREGNANCY BACKEND HERE (INSIDE the finally block)
            try:
                ...
                print(f"❌ Pregnancy backend error: {e}")
    ...
    # === PREGNANCY BACKEND INTEGRATION ===
    try:
        from pregnancy_backend import create_pregnancy_backend
        
        print("\n🤱 Starting Pregnancy Backend...")
        pregnancy_backend = create_pregnancy_backend(ai)
        pregnancy_status = pregnancy_backend.start_server()
        print(pregnancy_status)
        print("🌐 Pregnancy web interface: http://127.0.0.1:8000")
        
    except ImportError:
        print("⚠️  pregnancy_backend.py not found - skipping web interface")
    except Exception as e:
        print(f"❌ Pregnancy backend error: {e}")